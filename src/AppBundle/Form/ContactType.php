...
class ContactType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('website', TextType::class, array('attr' => array('placeholder' => 'Your Website'),
                'required'   => false
            ))

            ->add('place', TextType::class, array('attr' => array('placeholder' => 'Your place'),
                'required'   => false
            ))

            ->add('subject', TextType::class, array('attr' => array('placeholder' => 'Subject(*)'),
                'constraints' => array(
                    new NotBlank(array("message" => "Please provide a subject here")),
                )
            ))

            ->add('message', TextareaType::class, array('attr' => array('placeholder' => 'Message here (*)'),
                'constraints' => array(
